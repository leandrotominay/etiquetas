...
<head>
    ...
    <title>Gerenciador de Etiquetas</title>
    <!-- Favicon icon -->
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="../etiquetas2/upload.php" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="apagarDoc.php" aria-expanded="false">
                ...
                <div class="row align-items-stretch">
                    <div class="col-xl-9 col-md-12 d-flex align-items-stretch justify-content-strech">
                        <div class="card w-100">
                            <div class="card-body">
                                <h1 class="card-title">O Arquivo foi importado com sucesso!</h1>
                                <div class="pt-5" style="height: 490px;">

                                    <h3>Próximo passo: Volte para a aba "Importar arquivo" e após entrar nela clique na aba "Aplique Arquivo".</h3>
