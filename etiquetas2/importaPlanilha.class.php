        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            <div class="user-profile text-center pt-2">
                ...
                <div class="profile-section">
                    <p class="font-weight-light mb-0 font-18">Maria Cristina</p>
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="../etiquetas2/apagarDoc.php" aria-expanded="false">
                ...
                <div class="row align-items-stretch">
                    <div class="col-xl-9 col-md-12 d-flex align-items-stretch justify-content-strech">
                        <div class="card w-100">
                            <div class="card-body">
                                <h1 class="card-title">Aplicações feitas com sucesso!</h1>
...
ini_set('display_errors', 0 );
 ...
 echo 'Clique em "GERAR PDF" para ver o resultado! <br> <br>';
